...
5. **Be sure to copy address, password and download keystore file for each key without closing browser's tab**. There is no way to get this data once you close the tab.
